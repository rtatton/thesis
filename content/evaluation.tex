...
% TODO Confirm if custom spacing is needed once this section is done
...
\begin{sidewaystable}[htbp]
  ...
  \begin{tabular}{lccc}
    \toprule
    Attribute & \labelcref{rq:parameters} & \labelcref{rq:distributions} & \labelcref{rq:topology} \\
    \midrule
    ...
    \bottomrule
  \end{tabular}
  \caption[Experiment configurations]{Experiment configurations. See \cref{tab:default-parameters} for default parameter values. The send coefficient and tolerance were evaluated independently for \labelcref{rq:parameters}. The notation $X^k$ is used to denote the $k$-ary Cartesian power of the set $X$. A ``burn-in'' repetition was used for \labelcref{rq:distributions} and \labelcref{rq:topology} to avoid measuring the impact of Java class loading.}
