...
The \cRiskPropagationActor{} operation defines the behavior of an actor. Compared to asynchronous risk propagation (\Cref{sec:asynchronous}), actor behavior differs in two significant ways:
\begin{enumerate}
