...
\begin{tikzpicture}
    ...
    \nextgroupplot[title={$\vScoreValue(v) = 0.2$}, ymax=24, ytick distance=6]
    ...
    \nextgroupplot[title={$\pSendCoeff = 0.2$}, ymax=24, ytick distance=6]
    \addplot [domain=0:1, samples=100, color=black, thick, dotted]{log2(0.2 * (0.8 * 0.2) / (0.8 * x)) / log2(0.8)};
    ...
    \nextgroupplot[title={$\vScoreValue(v) = 0.8$}, ymax=12, ytick distance=3]
    ...
    \nextgroupplot[title={$\pSendCoeff = 0.8$}, ymax=12, ytick distance=3]
