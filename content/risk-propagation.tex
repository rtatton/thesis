...
An updated definition of \cApplyRiskScore{} that incorporates this new aspect of message passing is provided below. Assuming a finite number of actors, a positive send coefficient guarantees that a risk score has finite propagation.
...
% Message optimizations - sender-side aggregation \citep{McCune2015}
