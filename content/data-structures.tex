...
A \define{dynamic set} $\vSomeSet$ is a mutable collection of distinct elements such that $\vSomeElement$ is a pointer to an element in $\vSomeSet$. The value of the key attribute $\aSomeElementKey$ uniquely identifies $\vSomeElement$ within $\vSomeSet$. A dynamic set $\vSomeSet$ supports the following operations \citep{Cormen2022}.
\begin{itemize}
